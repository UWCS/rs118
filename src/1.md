...
The code snippets in this documentation can be run using the play button in the top right corner, try it:
...
fn mul(a: f64, b: f64) {
    println!("this function returns the product of it's parameters");
    a*b
}
